...
const ProductCard = ({ product }) => {
    ...
    return (
        <div className="card card-compact w-full bg-base-800 shadow-xl relative">
            <figure>
            ...
            <div className="card-body">
                ...
                <div className="card-actions flex items-center mt-3">
                    <p className="text-[#FF3811] font-bold text-xl sm:mr-4 md:mr-6 ">Price: ${price}</p>
                    <Rating
                    ...
                    <div className="absolute -top-0 right-2 mt-2 mr-2">
